import { AxesHelper, Color, ConeBufferGeometry, Math as Math$1, Matrix4, Mesh, MeshBasicMaterial, Object3D, Vector3 } from '../../_snowpack/pkg/three.js';
...
var IKJoint = function () {
  ...
  createClass(IKJoint, [{
    ...
    value: function _worldToLocalDirection(direction) {
      if (this.bone.parent) {
        // var inverseParent = new Matrix4().getInverse(this.bone.parent.matrixWorld) //depricated in Three 0.126.1;
