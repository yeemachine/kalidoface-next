import { T as Texture } from '../common/core.es-e8c084f6.js';
...
function () {
  ...
  function Loader(baseUrl, concurrency) {
    ...
    this.onComplete = new MiniSignal(); // Add default before middleware
...
export { Loader$1 as Loader, LoaderResource };
